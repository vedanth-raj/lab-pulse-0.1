...
const vec3 PINK  = vec3(245.0, 158.0, 11.0) / 255.0;
const vec3 BLUE  = vec3(120.0, 53.0, 15.0) / 255.0;
...
export default function FloatingLines({
  ...
  useEffect(() => {
    ...
    const eventTarget: Window | HTMLElement = interactive ? window : renderer.domElement;
